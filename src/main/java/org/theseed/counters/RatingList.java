 ...
 *
 */
public class RatingList<E extends Comparable<E>> implements Iterable<RatingList.Rating<E>> {
     ...
     * @param <E>
     */
    public static class Rating<E extends Comparable<E>> implements Comparable<Rating<E>> {
         ...
         */
        private Rating(E key, double value) {
            this.key = key;
            this.value = value;
        }
